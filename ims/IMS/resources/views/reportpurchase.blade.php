			...
			<div class="grid_12 full_block">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h3>Report On Purchases</h3>
						<form action="reportpurchases/today" method="post" role="form" class="form_container left_label">
					...
					<div class="widget_content">
						...
						<form action="reportpurchases/fromtoday" method="post" role="form" class="form_container left_label">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<input type="hidden" name="userid" value="{{ Auth::id() }}">
