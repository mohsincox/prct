			...
			<div class="grid_12 full_block">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h3>Balance Sheet</h3>
						<form action="balancesheet/today" method="post" role="form" class="form_container left_label">
					...
					<div class="widget_content">
						...
						<form action="balancesheet/fromtoday" method="post" role="form" class="form_container left_label">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
