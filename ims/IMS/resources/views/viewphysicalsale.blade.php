...
<div class="clear"></div>
								...
								<div class="grid_6 invoice_to">
									<ul>
										...
										<?php $gamount=$p->gamount;?>
										<?php $previousdue=$p->previousdue;?>
										<?php $presentbalance=$p->presentbalance;?>
										<?php $status=$p->status;?>
								...
								<div class="grid_12 invoice_details">
									<div class="invoice_tbl">
										...
										<tr>
											...
											<td>
												<?php echo number_format($previousdue, 2, '.', '');?>
											</td>
										</tr>
										<tr>
											<td colspan="4" class="grand_total">
											...
											<td>
												<?php echo number_format($presentbalance, 2, '.', '');?>
											</td>
										</tr>
										<?php //} ?>
										</tbody>
									...
									<p class="amount_word">
										Amounts in word: <span><?php echo App\Http\Controllers\Common\CommonController::convertNumberToWord(number_format($gamount, 2, '.', '')); ?> Taka Only</span>
									</p>
