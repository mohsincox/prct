						...
						<input type="hidden" name="userid" value="{{ Auth::id() }}">
							...
							<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<select class="chzn-select" style=" width:100%" name="purchaseid"> 
                         ...
                         <option value="<?php echo $gg->id; ?>" <?php echo 'selected'?>><?php echo $gg->name; ?></option>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
									<input name="purchasedate" type="text" tabindex="1" class="datepicker" />
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="amount" type="text" tabindex="1"  />
									</div>
								</div>
								</li>
								<!--<li>
