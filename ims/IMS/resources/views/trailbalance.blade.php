			...
			<div class="grid_12 full_block">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h3>Trail Balance</h3>
						<form action="trialbalance/today" method="post" role="form" class="form_container left_label">
					...
					<div class="widget_content">
						...
						<form action="trialbalance/fromtoday" method="post" role="form" class="form_container left_label">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
