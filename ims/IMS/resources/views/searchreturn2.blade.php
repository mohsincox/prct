...
<div class="clear"></div>
								...
								<div class="grid_6 invoice_to">
									<ul>
										<li>
										<strong><span>Name/Title:<?php echo $cname; ?></span></strong>
										<span>Address:<?php echo $preaddress; ?></span>
										<span>Mobile No:<?php echo $phone; ?></span>
								...
								<div class="grid_6 invoice_from">
									<ul>
										<li>
										<strong><span>Date:<?php echo $salesdate; ?></span></strong>
							
										<span>Voucher No:<?php echo $salesname; ?></span>
								...
								<div class="grid_12 invoice_details">
									<div class="invoice_tbl">
										...
										<tbody>
										<?php $i=1; foreach($fiall as $f){?>
										<tr>
											<td class="center"><?php echo $i; ?></td>
											<td class="center"><?php echo $f->salesdate; ?></td>
											<td class="center"><?php echo $f->itemsname; ?></td>
											<td class="center"><?php echo $f->slno; ?></td>
