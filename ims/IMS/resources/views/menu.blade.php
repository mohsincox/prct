	...
	<div id="start_menu">
		<ul>
			...
			<ul class="black_gel">
				...
				<ul>
					<li><a href="/IMS/psanalys"><span class="list-icon documents_b">&nbsp;</span>Loss & Profit Analys<span class="mnu_tline">Loss & Profit Analys</span></a></li>
...
<div id="container">
		...
		<div class="header_right">
			...
			<div id="user_nav">
				<ul>
					...
					<li class="user_info"><span class="user_name">{{ Auth::user()->name }}</span><span><a href="/IMS/companyprofile">Company Profile</a> &#124; <a href="#">Help&#63;</a></span></li>
	...
	<div class="switch_bar">
		<ul>
		    <li><a href="/IMS/physicalsales/addnew"><span class="stats_icon bank_sl"><span class="alert_notify blue">30</span></span><span class="label">Sales</span></a></li>
			<li><a href="/IMS/purchase/addnew"><span class="stats_icon bank_sl"><span class="alert_notify blue">30</span></span><span class="label">Purchases</span></a></li>
			<li><a href="/IMS/customers/addnew" ><span class="stats_icon user_sl"><span class="alert_notify orange">30</span></span><span class="label">Client</span></a></li>
			<li><a href="/IMS/suppliers/addnew" ><span class="stats_icon user_sl"><span class="alert_notify orange">30</span></span><span class="label">Supplier</span></a></li>
			...
			<li><a href="/IMS/itemmaster/addnew"><span class="stats_icon archives_sl"><span class="alert_notify blue">30</span></span><span class="label">Items</span></a></li>
			<li><a href="/IMS/customers"><span class="stats_icon address_sl"></span><span class="label">Customer</span></a></li>
			<li><a href="/IMS/suppliers"><span class="stats_icon folder_sl"></span><span class="label">Supplier</span></a></li>
